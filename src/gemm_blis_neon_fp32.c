...
void gemm_microkernel_Cresident_neon_7x12_unroll_4_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
...
void gemm_microkernel_Cresident_neon_7x12_unroll_4_fp32_fixed( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_4x4_prefetch_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
...
/*
void gemm_microkernel_Cresident_neon_4x4_nopackA_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
...
void gemm_microkernel_Cresident_neon_7x12_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_7x12_unroll_2_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_7x12_nopack_unroll_4_fp32( int mr, int nr, int kc, float alpha, float *Ar, int ldA, float *Br, int ldB, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_7x12_nopackA_unroll_4_fp32( int mr, int nr, int kc, float alpha, float *Ar, int ldA, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_7x12_nopackA_unroll_4_fp32_fixed( int mr, int nr, int kc, float alpha, float *Ar, int ldA, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 7x12, with kc<=12
*/
...
void gemm_microkernel_Cresident_neon_8x12_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
...
#define C7n B2n 
  ...
  if ( (mr<MR)||(nr<NR) ) {
    ...
    //if ( beta!=zero ) {
/*
      C00n = vld1q_f32(&Crow(0,0)); C01n = vld1q_f32(&Crow(0,4)); C02n = vld1q_f32(&Crow(0,8));
      C00  = C00n + C00;            
      ...
      C00n = vld1q_f32(&Crow(1,0)); C01n = vld1q_f32(&Crow(1,4)); C02n = vld1q_f32(&Crow(1,8));
      C10  = C00n + C10;            
      ...
      C00n = vld1q_f32(&Crow(2,0)); C01n = vld1q_f32(&Crow(2,4)); C02n = vld1q_f32(&Crow(2,8));
      C20  = C00n + C20;            
      ...
      C00n = vld1q_f32(&Crow(3,0)); C01n = vld1q_f32(&Crow(3,4)); C02n = vld1q_f32(&Crow(3,8));
      C30  = C00n + C30;            
      ...
      C00n = vld1q_f32(&Crow(4,0)); C01n = vld1q_f32(&Crow(4,4)); C02n = vld1q_f32(&Crow(4,8));
      C40  = C00n + C40;            
      ...
      C00n = vld1q_f32(&Crow(5,0)); C01n = vld1q_f32(&Crow(5,4)); C02n = vld1q_f32(&Crow(5,8));
      C50  = C00n + C50;            
      ...
      C00n = vld1q_f32(&Crow(6,0)); C01n = vld1q_f32(&Crow(6,4)); C02n = vld1q_f32(&Crow(6,8));
      C60  = C00n + C60;            
      ...
      C00n = vld1q_f32(&Crow(7,0)); C01n = vld1q_f32(&Crow(7,4)); C02n = vld1q_f32(&Crow(7,8));
      C70  = C00n + C70;            
      ...
      C00n = vld1q_f32(&Crow(0,0)); C01n = vld1q_f32(&Crow(0,4)); C02n = vld1q_f32(&Crow(0,8));
      C00  = C00n + C00;            C01  = C01n + C01;            C12  = C02n + C12;
      vst1q_f32(&Crow(0,0), C00); vst1q_f32(&Crow(0,4), C01); vst1q_f32(&Crow(0,8), C02);

      C00n = vld1q_f32(&Crow(1,0)); C01n = vld1q_f32(&Crow(1,4)); C02n = vld1q_f32(&Crow(1,8));
      C10  = C00n + C10;            C11  = C01n + C11;            C12  = C02n + C12;
      vst1q_f32(&Crow(1,0), C10); vst1q_f32(&Crow(1,4), C11); vst1q_f32(&Crow(1,8), C12);

      C00n = vld1q_f32(&Crow(2,0)); C01n = vld1q_f32(&Crow(2,4)); C02n = vld1q_f32(&Crow(2,8));
      C20  = C00n + C20;            C21  = C01n + C21;            C22  = C02n + C22;
      vst1q_f32(&Crow(2,0), C20); vst1q_f32(&Crow(2,4), C21); vst1q_f32(&Crow(2,8), C22);

      C00n = vld1q_f32(&Crow(3,0)); C01n = vld1q_f32(&Crow(3,4)); C02n = vld1q_f32(&Crow(3,8));
      C30  = C00n + C30;            C31  = C01n + C31;            C32  = C02n + C32;
      vst1q_f32(&Crow(3,0), C30); vst1q_f32(&Crow(3,4), C31); vst1q_f32(&Crow(3,8), C32);

      C00n = vld1q_f32(&Crow(4,0)); C01n = vld1q_f32(&Crow(4,4)); C02n = vld1q_f32(&Crow(4,8));
      C40  = C00n + C40;            C41  = C01n + C41;            C42  = C02n + C42;
      vst1q_f32(&Crow(4,0), C40); vst1q_f32(&Crow(4,4), C41); vst1q_f32(&Crow(4,8), C42);

      C00n = vld1q_f32(&Crow(5,0)); C01n = vld1q_f32(&Crow(5,4)); C02n = vld1q_f32(&Crow(5,8));
      C50  = C00n + C50;            C51  = C01n + C51;            C52  = C02n + C52;
      vst1q_f32(&Crow(5,0), C50); vst1q_f32(&Crow(5,4), C51); vst1q_f32(&Crow(5,8), C52);

      C00n = vld1q_f32(&Crow(6,0)); C01n = vld1q_f32(&Crow(6,4)); C02n = vld1q_f32(&Crow(6,8));
      C60  = C00n + C60;            C61  = C01n + C61;            C62  = C02n + C62;
      vst1q_f32(&Crow(6,0), C60); vst1q_f32(&Crow(6,4), C61); vst1q_f32(&Crow(6,8), C62);

      C00n = vld1q_f32(&Crow(7,0)); C01n = vld1q_f32(&Crow(7,4)); C02n = vld1q_f32(&Crow(7,8));
      C70  = C00n + C70;            C71  = C01n + C71;            C72  = C02n + C72;
      vst1q_f32(&Crow(7,0), C70); vst1q_f32(&Crow(7,4), C71); vst1q_f32(&Crow(7,8), C72);
*/
...
void gemm_microkernel_Cresident_neon_fixed_8x12_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 8x12
*/
...
void gemm_microkernel_Cresident_neon_4x12_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
...
void gemm_microkernel_Cresident_neon_4x16_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
...
void gemm_microkernel_Cresident_neon_fixed_4x20_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
...
#define C3r B2
  ...
  if ( (mr<MR)||(nr<NR) ) {
    // printf("  Inside micro-kernel %d %d %d\n", mr, nr, kc);
...
void gemm_microkernel_Cresident_neon_4x20_fp32( int mr, int nr, int kc, float alpha, float *Ar, float *Br, float beta, float *C, int ldC ){
/*
  BLIS GEMM microkernel, computes the product Cr := Cr + Ar * Br
  Specific: only for MRxNR = 4x20
*/
